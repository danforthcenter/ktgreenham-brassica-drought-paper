...
def main():
    ...
    roi_contour, roi_hierarchy = pcv.roi.rectangle(img=img, x=700, y=50, h=1000, w=1000)
    ...
    newmask = pcv.crop_position_mask(img=grey, mask=nmask, x=37, y=6, v_pos="top", h_pos="right")
